...
if __name__ == "__main__":
    ...
    unigram = generate_unigram(tokens)
    bigram = generate_bigram(tokens)
    sentence = generate_sentence(bigram)
    word_types = len(unigram)
    pp = compute_pp(sentence, unigram, bigram, word_types)
